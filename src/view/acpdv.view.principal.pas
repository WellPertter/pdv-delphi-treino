// Deus é perfeito sempre e sempre será!!
...
{ Dicas/Ensinamentos:
  ...
  Dicas :
  bõtão direito - refactor - extratc method

  VK_F1 ( para mencionar as teclas  tem que ter o keypreview) ( começar a usar case)
}
...
begin
  ...
  case key of
    ...
    begin
      {
     TformIdentificarCliente.New(self)
    .Embed(pnlMaster)
    .show; }

     FPageIdentificacao.Show;

    end;
    VK_F9:
    begin

      FPageIdentificacao.identificarCPF.Show;    {
      TformIdentificarCliente.New(self)
      .identificarCPF()
      .Embed(pnlMaster)
      .show;    ||\                   }
